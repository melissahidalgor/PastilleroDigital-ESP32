...
El ESP32 aloja un servidor web que sirve una interfaz (HTML/CSS/JS) para la administración remota. Se usan SPIFFS (Serial Peripheral Interface Flash File System) para almacenar y servir todos los archivos estáticos de la interfaz web.
...
**Comunicación Cliente-Servidor:** 
  `handleRecibirProximaToma()`: Recibe los datos de la próxima dosis desde la página web y los almacena en el ESP32.
